...
## Core Model Design
ArcLight-AttGRU integrates lightweight convolution, recurrent neural network and attention mechanism, and combines structured pruning strategy to realize the balance of detection accuracy and model lightweight:
- **SeparableConv1D Block**: Two stacked depthwise separable convolution layers with batch normalization, efficiently extract local disturbance features of low-frequency current time series with low computational cost
